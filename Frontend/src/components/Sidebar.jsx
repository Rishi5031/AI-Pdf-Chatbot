      ...
      <div className="px-4 pb-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-neutral/10 border border-neutral/30 rounded-lg text-sm text-tertiary focus:outline-none focus:ring-1 focus:ring-secondary/50 transition-all placeholder-neutral/70"
          />
        </div>
      </div>
