...
export default function AccountStatistics({ statistics, createdAt }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/90 p-6 shadow-xs mb-6">
      <div className="flex items-center gap-2 mb-5">
        <svg className="w-5 h-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
        </svg>
        <h2 className="text-lg font-bold text-slate-800">Activity Statistics</h2>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3.5">
        {statsList.map((stat) => (
          <div
            key={stat.id}
            className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200/80 flex flex-col items-start justify-between min-h-[90px]"
          >
