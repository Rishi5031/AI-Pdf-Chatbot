...
export default function Profile() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#f8f9fd] p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-3">
                ...
                {!isGoogleUser ? (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-900 leading-tight">Password</p>
                        <p className="text-xs text-slate-500 mt-0.5">Change your access key</p>
                      </div>
                    </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-red-600 leading-tight">Delete Account</p>
                      <p className="text-xs text-red-400/90 mt-0.5">Permanent deletion of data</p>
                    </div>
                  </div>
